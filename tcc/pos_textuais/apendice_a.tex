\begin{apendicesenv}
\chapter{CÓDIGO-FONTE DO ORQUESTRADOR}
\label{apendice:codigo_orquestrador}

O código a seguir, extraído do arquivo \texttt{core/crew\_manager.py}, ilustra como a "tripulação" de agentes é definida, como as tarefas são encadeadas e como o processo é iniciado. Este componente pertence à \textbf{Camada de Orquestração} e atua como o "maestro" que rege a colaboração entre os agentes.
